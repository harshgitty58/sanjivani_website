...
export default function Reviews() {
  ...
  useEffect(() => {
    const updateItems = () => {
      ...
      else if (width >= 640 && width <= 1366) setItemsPerPage(2);
  ...
  return (
    <section className="w-full bg-[#f2f1f9] py-10 sm:py-12 md:py-16 px-4 sm:px-6 md:px-10 lg:px-20 flex justify-center">
...
//   return (
//     <div className="w-full bg-[#f2f1f9] py-5 px-4 flex justify-center pl-1 pr-16">
//       <div className="max-w-8xl w-full flex flex-col lg:flex-row items-center gap-1">
//         <div className="w-full lg:w-1/3 flex flex-col items-center justify-center text-center">
//           <h2 className="text-2xl font-bold text-indigo-800">EXCELLENT</h2>
//           <div className="flex gap-1 mt-2">
//             {Array(5)
//               .fill(0)
//               .map((_, i) => (
...
//           <button
//             onClick={prev}
//             className="absolute -left-3 sm:-left-4 lg:-left-8 bg-white p-2 rounded-full shadow hover:bg-gray-100 z-10"
//           >
//             <ChevronLeft className="w-5 h-5" />
//           </button>

//           <div className="flex w-full gap-10 overflow-hidden items-stretch">
//             {reviews
//               .slice(current, current + itemsPerPage)
//               .map((review) => (
//                 <div
//                   key={review.id}
//                   className="flex-1 min-w-0 border rounded-lg bg-white shadow-sm p-4 flex flex-col justify-between transition-all hover:shadow-md"
//                 >
//                   <div>
//                     <div className="flex items-center gap-3">
...
//                         src="/images/owner.jpg"
//                         alt="Google"
//                         className="ml-auto w-10 h-10 object-cover rounded-full"
//                       />
//                     </div>
...
//           <button
//             onClick={next}
//             className="absolute -right-3 sm:-right-4 lg:-right-8 bg-white p-2 rounded-full shadow hover:bg-gray-100 z-10"
//           >
